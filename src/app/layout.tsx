  ...
  return (
    <ClerkProvider>
      <html lang="en" className="dark">
        <body className={`${geistSans.variable} ${geistMono.variable} ${instrumentSerif.variable} ${newsreader.variable} antialiased selection:bg-primary selection:text-black`}>
          {children}
        </body>
      </html>
    </ClerkProvider>
